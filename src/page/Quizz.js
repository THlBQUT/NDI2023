...
const QuestionArray = [
    ...
    },
    {
        ...
        answers: [
            { answer: true, text: "Une méthode agricole caractérisée par l'utilisation intensive de machines et de produits chimiques" },
    ...
    },
    {
        ...
        answers: [
            { answer: true, text: "Il perturbe les schémas traditionnels en raison des variations de température et des habitats" },
    ...
    },
    {
        ...
        answers: [
            { answer: true, text: "Une perception positive d'une entreprise ou d'un produit en raison de ses actions environnementales, masquant d'autres impacts négatifs" },
    ...
    },
    {
        ...
        answers: [
            { answer: true, text: "Elle perturbe les cycles de vie naturels des espèces nocturnes et nuit à l'observation des étoiles" },
    ...
    },
    {
        ...
        answers: [
            { answer: true, text: "Ils facilitent le déplacement des espèces, contribuant ainsi à la diversité génétique et à la survie des populations" },
    ...
    },
    {
        ...
        answers: [
            { answer: true, text: "Elle perturbe les équilibres des chaînes alimentaires marines et entraîne la diminution des populations de poissons" },
    ...
    },
    {
        ...
        answers: [
            { answer: true, text: "Créer des systèmes agricoles durables en imitant les modèles et les relations observés dans la nature" },
